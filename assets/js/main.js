...
// Add click event listener to all portfolio-details-link elements
let portfolioDetailsLinks = document.querySelectorAll(
...
portfolioDetailsLinks.forEach((link) => {
  link.addEventListener("click", function (event) {
    ...
    let targetModalId = this.dataset.target;
